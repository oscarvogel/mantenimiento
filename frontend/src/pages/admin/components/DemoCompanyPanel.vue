...
<template>
  <div>
    <button
      type="button"
      class="fixed bottom-5 right-5 z-40 inline-flex min-h-11 items-center gap-2 rounded-xl bg-accent px-4 py-3 text-sm font-bold text-accent-foreground shadow-lg transition hover:bg-accent-hover focus:outline-none focus:ring-2 focus:ring-accent/40"
      @click="open = true"
    >
