...
Se incluyen capturas de desarrollo de las pantallas disponibles; no sustituyen
la validación obligatoria en el stack de staging canónico:
...
La vista previa real de las dos planillas requiere iniciar una importación y
confirmar el archivo desde la interfaz autenticada.
