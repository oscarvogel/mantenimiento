...
final class BranchNotificationLocaleContractTest extends TestCase
{
    public function testBranchLocaleOverridesCompanyLocaleWithCompanyFallback(): void
    {
        ...
        $service = file_get_contents(APPPATH . 'Application/Organization/TenantAdministrationService.php');
        ...
        foreach ([$migration, $tenant, $service, $administration, $payload, $branches, $queue, $public] as $source) {
