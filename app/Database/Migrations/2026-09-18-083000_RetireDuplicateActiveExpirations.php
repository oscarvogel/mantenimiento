...
final class RetireDuplicateActiveExpirations extends Migration
{
    ...
    {
        // No se reactiva historial automáticamente: sería ambiguo y podría reabrir vencimientos retirados a propósito.
    }
}
