...
final class QuickReadingsPayload
{
     ...
     */
    public function build(array $page, array $filters, array $photos, array $branches, array $types, bool $canRegister, \DateTimeImmutable $now): array
    {
        ...
        return [
            ...
            'routes' => ['index' => $base, 'submit' => $base, 'submitRow' => $base . '/fila', 'assets' => base_url('mantenimiento/equipos')],
            'filters' => [
            ...
            'equipment' => [
                ...
                'items' => array_map(function (array $row) use ($photos): array {
                    $id = (int) $row['id'];
