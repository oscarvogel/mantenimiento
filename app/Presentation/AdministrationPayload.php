    ...
    public function superadmin(array $source): array
    {
        ...
        return [
            ...
            'companies' => array_map(fn (array $row): array => [
                ...
                'managementReportEmails' => $row['emails_informes'] ?? '',
                'dailyReportEnabled' => (int) ($row['informe_diario_habilitado'] ?? 0) === 1,
                'dailyReportTime' => $row['informe_diario_hora'] ?? '07:00',
                'weeklyReportEnabled' => (int) ($row['informe_semanal_habilitado'] ?? 0) === 1,
                'weeklyReportDay' => (int) ($row['informe_semanal_dia'] ?? 1),
