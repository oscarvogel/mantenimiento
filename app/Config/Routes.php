...
$routes->group('mantenimiento', ['filter' => ['auth']], static function ($routes): void {
    ...
    $routes->get('maestros/equipos', 'AssetManagement::catalogs', ['filter' => 'permission:equipos.editar']);
    ...
    $routes->post('ordenes/(:num)/cancelar', 'MaintenanceCircuit::cancelOrder/$1', ['filter' => 'permission:ordenes.editar']);
